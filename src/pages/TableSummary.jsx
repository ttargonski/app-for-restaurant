...
const TableSummary = () => {
  ...
  const getTotalPrice = () => {
    let price = 0;
    tableOrder.map((order) => (price += order.price));
      ...
      <div className="col-10 m-auto">
        ...
        <ul className="list-group mb-3 p-0">
          {tableOrder.map((order, index) => (
            ...
            >
              <div>
                ...
                <small className="text-muted mr-3">Ilość: {order.amount}</small>
                <small className="text-muted">
                  Cena jednostkowa: {order.price}
                </small>
              </div>
          ...
          >
            ...
            <span className="text-success">${getTip()}</span>
          </li>
          <li
            key="totalPrice"
